              ...
              <Form>
                <ContentInputs>
                  <div className="name-lastname">
                    <div>
                      <label>Nome</label>
                      <InputField name="name" type="text" icon="User" />
                    ...
                    <div>
                      ...
                      <InputField name="lastName" type="text" icon="User" />
                  ...
                  <div>
                    ...
                    <InputField name="linkedIn" type="text" icon="Linkedin" />
                  ...
                  <div className="teste">
                    <div className="label-input">
                      <label>Discord*</label>
                      <InputField type="text" name="discord" icon="Discord" />
                    ...
                    <div className="label-input-phone">
                      ...
                      <InputField type="text" name="ddd" icon="Phone" />
